/**
 * @license  OpenTok JavaScript Library v2.0.18
 * http://www.tokbox.com/
 *
...
OT.properties = {
  version: "v2.0.18",         // The current version (eg. v2.0.4) (This is replaced by gradle)
  build: "f671691",    // The current build hash (This is replaced by gradle)
...
OT.Raptor.Socket = function(widgetId, messagingServer, Dispatcher) {
  ...
  var setState = OT.$.statable(this, ['disconnected', 'connecting', 'connected', 'error', 'disconnecting'], 'disconnected'),
      ...
      onConnectComplete = function onConnectComplete (error, sessionState, prefix) {
        if (error) {
          logAnalyticsEvent('Failure', "reason", prefix + error.code + ':' + error.message);
